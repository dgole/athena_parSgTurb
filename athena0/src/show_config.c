...
#endif
#if defined(PARTICLE_SELF_GRAVITY)
  ath_pout(0," Particle Self-gravity:                 ON\n");
#else
  ath_pout(0," Particle Self-gravity:                 OFF\n");
#endif
...
#if defined(PARTICLE_SELF_GRAVITY)
  par_sets("configure","particle self-gravity","ON","particle algorithm");
#else
  par_sets("configure","particle self-gravity","OFF","particle algorithm");
#endif

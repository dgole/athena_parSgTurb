...
/* Allocate and initialize cylindrical scaling factors */
      ...
      pG->par_Phi = (Real***)calloc_3d_array(n3z, n2z, n1z, sizeof(Real));
      if (pG->par_Phi == NULL) goto on_error16;
      pG->par_Phi_x = (Real***)calloc_3d_array(n3z, n2z, n1z, sizeof(Real));
      if (pG->par_Phi_x == NULL) goto on_error17;
      pG->par_Phi_y = (Real***)calloc_3d_array(n3z, n2z, n1z, sizeof(Real));
      if (pG->par_Phi_y == NULL) goto on_error18;
      pG->par_Phi_z = (Real***)calloc_3d_array(n3z, n2z, n1z, sizeof(Real));
      if (pG->par_Phi_z == NULL) goto on_error19;
      pG->par_gx = (Real***)calloc_3d_array(n3z, n2z, n1z, sizeof(Real));
      if (pG->par_gx == NULL) goto on_error20;
      pG->par_gy = (Real***)calloc_3d_array(n3z, n2z, n1z, sizeof(Real));
      if (pG->par_gy == NULL) goto on_error21;
      pG->par_gz = (Real***)calloc_3d_array(n3z, n2z, n1z, sizeof(Real));
      if (pG->par_gz == NULL) goto on_error22;
#endif
...
#ifdef PARTICLE_SELF_GRAVITY
  on_error22:
    free_3d_array(pG->par_gz);
  on_error21:
    free_3d_array(pG->par_gy);
  on_error20:
    free_3d_array(pG->par_gx);
  on_error19:
    free_3d_array(pG->par_Phi_z);
  on_error18:
    free_3d_array(pG->par_Phi_y);
  on_error17:
    free_3d_array(pG->par_Phi_x);
  on_error16:
    free_3d_array(pG->par_Phi);
#endif
#ifdef CYLINDRICAL
  on_error15:
    free_1d_array(pG->ri);

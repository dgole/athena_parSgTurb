...
#endif
#if defined(SELF_GRAVITY) || defined(PARTICLE_SELF_GRAVITY) || defined(FFT_ENABLED)
...
void RemapFlux_2ndorder(const Real *U,const Real eps,const int ji,const int jo, Real *F);
 ...
 * the integer piece because the Grid is periodic in y */
  ...
  if (yshear/Ly == (int)(yshear/Ly)) deltay = 0.0;
 ...
 * then it is possible that:  pD->Nx2 > joffset > pG->Nx2   */
  ...
  if (deltay/pG->dx2 == (int)(deltay/pG->dx2)) epsi = 0.0;
 ...
 * then it is possible that:  pD->Nx2 > joffset > pG->Nx2   */
  ...
  if (deltay/pG->dx2 == (int)(deltay/pG->dx2)) epso = 0.0;
...
/* Find the nearest periodic point */
      ...
      if (yshear/pG->dx2 == (int)(yshear/pG->dx2)) eps = 0.0;
...
void RemapFlux_2ndorder(const Real *U, const Real eps,

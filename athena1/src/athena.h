...
typedef struct Grid_s{
  ...
  Real ***par_Phi; /*!< grid centered gravitational potential for particles */
  Real ***par_Phi_x; /*!<grav. potential for particles on left x face of grid cell */
  Real ***par_Phi_y; /*!<grav. potential for particles on left y face of grid cell */
  Real ***par_Phi_z; /*!<grav. potential for particles on left z face of grid cell */
  Real ***par_gx;   /*!<grav. force in the x direction */
  Real ***par_gy;   /*!<grav. force in the y direction */
  Real ***par_gz;   /*!<grav. force in the z direction */
#endif
